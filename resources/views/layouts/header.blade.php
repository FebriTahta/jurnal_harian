...
<meta name="description" content="Permudah dokumentasi pekerjaan dengan mengisi jurnal harian setiap hari">
<meta property="og:title" content="Jurnal Harian"/>
<meta property="og:description" content="Permudah dokumentasi pekerjaan dengan mengisi jurnal harian setiap hari"/>
<meta property="og:image" itemprop="image" content="{{ asset('thumb.jpeg') }}">
<title>Jurnal Harian ADM & IT</title>
<meta name="csrf-token" content="{{ csrf_token() }}" />
<link rel="icon" href="{{ asset('thumb.jpeg') }}" type="image/x-icon">
<!-- Favicon-->
            ...
            <div class="card">
                ...
                <div class="body">
                    <ul class="list-unstyled menu">
                        ...
                        <li><a href="/jurnal-harian"><i class="zmdi zmdi-file-text"></i><span>Mengisi Jurnal</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
